...
public class SecondActivity extends ListActivity  implements android.view.View.OnClickListener{
    ...
    public void onClick(View view) {
        if (view == findViewById(R.id.btnAdd)) {
            ...
            if (courseList.size() != 0) {
                ...
                ListAdapter adapter = new SimpleAdapter(SecondActivity.this, courseList, R.layout.view_course_entry, new String[]{"id", "name"}, new int[]{R.id.course_Id, R.id.course_name});
